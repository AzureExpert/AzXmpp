...
{
    [EventSource(Name = "AzXmpp-Transport")]
    internal sealed partial class ServiceEventSource : EventSource
    {
        ...
        [Event(5, Level = EventLevel.Informational, Message = "Service is running")]
